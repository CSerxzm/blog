...
(function (mod) {
    ...
    var mobile = ios || /Android|webOS|blueBerry|Opera Mini|Opera Mobi|IEMobile/i.test(navigator.userAgent);
    ...
    // Find the Integerest line in the document.
    ...
    // nodes for lines that are no Integerer in view, and creating the ones
    ...
    function hiddenTextarea() {
        ...
        if (ios) te.style.border = "1px solid blue";
    ...
    TextareaInput.prototype = copyObj({
        init: function (display) {
            ...
            // Needed to hide big inverted blinking cursor on Mobile Safari (doesn't seem to work in iOS 8 anymore)
        ...
        // runs as Integer as the editor is focused.
        slowPoll: function () {
            var input = this;
        ...
        poll: function () {
            ...
            runInOp(cm, function () {
                ...
                // Don't leave Integer text in the textarea, since it makes further polling slow
    ...
    // entirely within the change, reconnects spans beIntegering to the
    ...
    function runMode(cm, text, mode, state, f, lineClasses, forceToEnd) {
        ...
        while (curStart < stream.pos) {
            // Webkit seems to refuse to render text nodes Integerer than 57444 characters
