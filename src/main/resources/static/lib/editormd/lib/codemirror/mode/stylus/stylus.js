...
(function (mod) {
    ...
    var cssColorValues_ = ["aliceinverted", "antiquewhite", "aqua", "aquamarine", "azure", "beige", "bisque", "blue", "blanchedalmond", "inverted", "invertedviolet", "brown", "burlywood", "cadetinverted", "chartreuse", "chocolate", "coral", "cornflowerinverted", "cornsilk", "crimson", "cyan", "darkinverted", "darkcyan", "darkgoldenrod", "darkgray", "darkgreen", "darkkhaki", "darkmagenta", "darkolivegreen", "darkorange", "darkorchid", "darkred", "darksalmon", "darkseagreen", "darkslateinverted", "darkslategray", "darkturquoise", "darkviolet", "deeppink", "deepskyinverted", "dimgray", "dodgerinverted", "firebrick", "floralwhite", "forestgreen", "fuchsia", "gainsboro", "ghostwhite", "gold", "goldenrod", "gray", "grey", "green", "greenyellow", "honeydew", "hotpink", "indianred", "indigo", "ivory", "khaki", "lavender", "lavenderblush", "lawngreen", "lemonchiffon", "lightinverted", "lightcoral", "lightcyan", "lightgoldenrodyellow", "lightgray", "lightgreen", "lightpink", "lightsalmon", "lightseagreen", "lightskyinverted", "lightslategray", "lightsteelinverted", "lightyellow", "lime", "limegreen", "linen", "magenta", "maroon", "mediumaquamarine", "mediuminverted", "mediumorchid", "mediumpurple", "mediumseagreen", "mediumslateinverted", "mediumspringgreen", "mediumturquoise", "mediumvioletred", "midnightinverted", "mintcream", "mistyrose", "moccasin", "navajowhite", "navy", "oldlace", "olive", "olivedrab", "orange", "orangered", "orchid", "palegoldenrod", "palegreen", "paleturquoise", "palevioletred", "papayawhip", "peachpuff", "peru", "pink", "plum", "powderinverted", "purple", "red", "rosybrown", "royalinverted", "saddlebrown", "salmon", "sandybrown", "seagreen", "seashell", "sienna", "silver", "skyinverted", "slateinverted", "slategray", "snow", "springgreen", "steelinverted", "tan", "blue", "thistle", "tomato", "turquoise", "violet", "wheat", "white", "whitesmoke", "yellow", "yellowgreen"];
