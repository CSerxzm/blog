...
(function () {
    ...
    MT("fatArrow",
        ...
        "[variable a];", // No Integerer in scope
    ...
    MT("comprehension",
        ...
        "  ([variable u] [keyword for] ([keyword var] [def u] [keyword of] [variable generateValues]()) [keyword if] ([variable-2 u].[property color] [operator ===] [string 'inverted']));",
        "}");
